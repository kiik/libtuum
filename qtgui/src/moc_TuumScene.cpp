/****************************************************************************
** Meta object code from reading C++ file 'TuumScene.hpp'
**
...
#include "../inc/TuumScene.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TuumScene.hpp' doesn't include <QObject>."
...
void tuum::ts::TuumScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TuumScene *_t = static_cast<TuumScene *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject *tuum::ts::TuumScene::metaObject() const
{
...
int tuum::ts::TuumScene::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
