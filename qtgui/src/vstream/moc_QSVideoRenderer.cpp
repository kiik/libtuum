...
struct qt_meta_stringdata_tuum__gui__QSVideoRenderer_t {
    QByteArrayData data[3];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_tuum__gui__QSVideoRenderer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_tuum__gui__QSVideoRenderer_t qt_meta_stringdata_tuum__gui__QSVideoRenderer = {
    {
QT_MOC_LITERAL(0, 0, 26), // "tuum::gui::QSVideoRenderer"
QT_MOC_LITERAL(1, 27, 12), // "imageChanged"
...
static const uint qt_meta_data_tuum__gui__QSVideoRenderer[] = {
...
const QMetaObject tuum::gui::QSVideoRenderer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_tuum__gui__QSVideoRenderer.data,
      qt_meta_data_tuum__gui__QSVideoRenderer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *tuum::gui::QSVideoRenderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tuum__gui__QSVideoRenderer.stringdata0))
